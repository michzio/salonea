...
public interface PaymentMethodFacadeInterface extends AbstractFacadeInterface<PaymentMethod> {
    ...
    List<PaymentMethod> findByName(String name, Integer start, Integer offset);
    List<PaymentMethod> findInAdvance(Boolean inAdvance);
    List<PaymentMethod> findInAdvance(Boolean inAdvance, Integer start, Integer offset);
    List<PaymentMethod> findByNameAndInAdvance(String name, Boolean inAdvance);
    List<PaymentMethod> findByNameAndInAdvance(String name, Boolean inAdvance, Integer start, Integer offset);
    List<PaymentMethod> findByProvider(Provider provider);
    List<PaymentMethod> findByProvider(Provider provider, Integer start, Integer offset);
