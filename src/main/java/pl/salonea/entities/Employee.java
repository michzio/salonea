...
@NamedQueries({
        ...
        @NamedQuery(name = Employee.FIND_BY_TERM, query = "SELECT DISTINCT e FROM Employee e INNER JOIN e.termsOnWorkStation empl_term WHERE empl_term.term = :term"),
        @NamedQuery(name = Employee.FIND_BY_TERM_EAGERLY, query = "SELECT DISTINCT e FROM Employee e INNER JOIN FETCH e.termsOnWorkStation empl_term LEFT JOIN FETCH e.educations " +
                "LEFT JOIN FETCH e.skills LEFT JOIN FETCH e.suppliedServices LEFT JOIN FETCH e.receivedRatings WHERE empl_term.term = :term"),
        ...
        @NamedQuery(name = Employee.COUNT_BY_TERM, query = "SELECT COUNT(DISTINCT e) FROM Employee e INNER JOIN e.termsOnWorkStation empl_term WHERE empl_term.term = :term"),
})
public class Employee extends NaturalPerson {
    ...
    public static final String FIND_BY_TERM = "Employee.findByTerm";
    public static final String FIND_BY_TERM_EAGERLY = "Employee.findByTermEagerly";
    ...
    public static final String COUNT_BY_TERM = "Employee.countByTerm";
