...
public class ProviderServiceFacadeIT {
    ...
    public void shouldFindByMultipleCriteria() throws Exception {
        ...
        List<ProviderService> matchingOffers = providerServiceFacade.findByMultipleCriteria(providers, services, null, null, null, null, false, null, null, null, null, null);
        ...
        List<ProviderService> cheapHairOffers = providerServiceFacade.findByMultipleCriteria(null, hairServices, null, descriptions, 40.0, 70.0, false, null, null, null, null, null );
        ...
        List<ProviderService> cheapDiscountedHairOffers = providerServiceFacade.findByMultipleCriteria(null, hairServices, null, descriptions, 40.0, 70.0, true, null, null, null, null, null);
        ...
        List<ProviderService> discountedOffers = providerServiceFacade.findByMultipleCriteria(providers, null, null, null, null, null, false, (short) 10, (short) 60, null, null, null);
